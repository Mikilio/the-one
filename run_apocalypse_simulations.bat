...
java -Xmx512M -cp target;lib/ECLA.jar;lib/DTNConsoleConnection.jar core.DTNSim %* -b 1   apocalypse_settings/Magistrale114.txt

echo Running OtherFloors113.txt (1 run)
java -Xmx512M -cp target;lib/ECLA.jar;lib/DTNConsoleConnection.jar core.DTNSim %* -b 1   apocalypse_settings/OtherFloors113.txt
